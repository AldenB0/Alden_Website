...
const Outside = () => {
  const videoHTML = `
    <video autoplay loop muted playsinline class="object-cover w-full h-auto min-w-[60rem] max-w-[76rem]">
  ...
  return (
    <div id="mitre" className="w-5/6 sm:py-16 py-10">
      <Link to="/Outside_CaseStudy">
        ...
        <div
          className="sm:h-[30rem] h-[25rem] overflow-hidden flex justify-center rounded-3xl video bg-[#FCF6EC]"
