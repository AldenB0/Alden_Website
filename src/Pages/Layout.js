...
// You should remove the nav_anim from the ul once you reroute the contact li
  return (
    ...
    <>
      <nav className={`w-full flex ${styles.paddingX} py-5 justify-between items-center navbar text-lg`}>
        ...
        <ul className='list-none sm:flex hidden justify-end items-center flex-1 '> 
          ...
          <li className='font-body font-semibold text-white cursor-pointer top-2 nav_anim'>
            <Scroll to="footer" spy={true} smooth={true} offset={50} duration={500}>
              Contact
            </Scroll>
          </li>
        </ul>
        ...
        <div className="sm:hidden flex">
          ...
          <div
            className={`${toggle ? 'flex' : 'hidden'} p-6  bg-black-gradient absolute top-16 right-0 mx-4 my-2 min-w-[140px] rounded-xl sidebar`}
          >
